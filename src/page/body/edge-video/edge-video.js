...
export default function EdgeVideo(){
    return(
        <>
            <section className="section-edge-video">
                ...
                <div className="container-edge-video-mobile">
                <iframe src="https://player.vimeo.com/video/578074333?title=0&byline=0&portrait=0&muted=1&autoplay=10&autopause=0&controls=0&loop=1&app_id=122963" width="320" height="300" frameborder="0" allow="autoPlay; fullscreen" allowfullscreen=""></iframe>   
                </div>
            </section>
        </>
    )
